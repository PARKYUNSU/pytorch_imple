...
| **[LLM (Large Language Models)](https://github.com/PARKYUNSU/pytorch_imple/tree/main/NLP/LLM)**   | 2022 |
...
| 논문 제목                                    | 연도 |
|---------------------------------------------|-----|
| **[Multimodal RAG](https://github.com/PARKYUNSU/pytorch_imple/tree/main/Agentic_RAG/Multimodal_RAG)**  | 2025 |
| **[CRAG (Corrective Retrieval Augmented Generation)](https://github.com/PARKYUNSU/pytorch_imple/tree/main/Agentic_RAG/CRAG)**  | 2024 |
| **[SELF-RAG (Self-Reflective Retrieval-Augmented Generation)](https://github.com/PARKYUNSU/pytorch_imple/tree/main/Agentic_RAG/Self_RAG)**  | 2024 |
...
OpenAI 및 HuggingFace 등 다양한 AI 모델을 활용하는 예제를 정리한 섹션입니다.
텍스트 생성, 음성 인식, 이미지 생성 등 여러 주제를 포함하고 있습니다.

### 1. OpenAI Playground & API 활용

| 파일명                                                     | 간단 설명                                                                                     |
|:---------------------------------------------------------|:-------------------------------------------------------------------------------------------|
| **[playground api](https://github.com/PARKYUNSU/pytorch_imple/blob/main/Education/Openai_api/open_ai_00_playground_api.ipynb)**                      | OpenAI Playground API를 사용해 텍스트 생성 모델을 실험하는 기본 예제입니다.                     |
...
| 파일명                                                                           | 간단 설명                                                                                           |
|:-------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------|
| **[허깅페이스 이용한 AI 모델 가져와쓰기](https://github.com/PARKYUNSU/pytorch_imple/blob/main/Education/Openai_api/open_ai_04_%ED%97%88%EA%B9%85%ED%8E%98%EC%9D%B4%EC%8A%A4%EB%A5%BC_%EC%9D%B4%EC%9A%A9%ED%95%9C_AI_%EB%AA%A8%EB%8D%B8_%EA%B0%96%EB%8B%A4%EC%93%B0%EA%B8%B0_%EC%B6%94%EA%B0%80.ipynb)**                      | HuggingFace에서 제공하는 사전학습된 모델을 로드해 활용하는 방법을 다룹니다.                             |
| **[HuggingFace Embedding(gpe_m3)](https://github.com/PARKYUNSU/pytorch_imple/blob/main/Education/Openai_api/open_ai_06_HuggingFace_Embedding(bge_m3).ipynb)**                              | HuggingFace 임베딩 모델(gpe_m3)을 사용하여 텍스트 임베딩/유사도 계산을 수행하는 예제입니다.              |
| **[HuggingFace Embedding(efs_gpe)](https://github.com/PARKYUNSU/pytorch_imple/blob/main/Education/Openai_api/open_ai_07_HuggingFace_Embedding(e5).ipynb)**                             | HuggingFace 임베딩 모델(efs_gpe)을 활용한 또 다른 임베딩/검색 예제입니다.                              |

### 3. 멀티모달 & 생성 모델

| 파일명                                                  | 간단 설명                                                                    |
|:------------------------------------------------------|:--------------------------------------------------------------------------|
| **[GPT4V](https://github.com/PARKYUNSU/pytorch_imple/blob/main/Education/Openai_api/open_ai_08_GPT4V.ipynb)**                            | GPT-4 Vision(이미지 인식 기능)을 활용하는 간단 예제입니다.                      |
| **[TTS](https://github.com/PARKYUNSU/pytorch_imple/blob/main/Education/Openai_api/open_ai_09_TTS.ipynb)**                              | Text-to-Speech(TTS) 기능을 활용해 텍스트를 음성으로 변환하는 예제입니다.         |
| **[ChatGPTWhisper 음성회의록](https://github.com/PARKYUNSU/pytorch_imple/blob/main/Education/Openai_api/open_ai_10_chatGPT%EC%99%80_whisper_%EC%9D%8C%EC%84%B1%ED%9A%8C%EC%9D%98%EB%A1%9D.ipynb)**         | ChatGPT Whisper 모델을 사용해 음성 회의록(스피치 투 텍스트)으로 변환하는 예제입니다. |
| **[Dalle 이미지 생성 일러스트](https://github.com/PARKYUNSU/pytorch_imple/blob/main/Education/Openai_api/open_ai_11_Dalle_%EC%9D%B4%EB%AF%B8%EC%A7%80%20%EC%83%9D%EC%84%B1.ipynb)**         | DALL-E 모델을 통해 텍스트로부터 이미지를 생성하는 예제입니다.                   |
| **[자동 자막 생성 서비스](https://github.com/PARKYUNSU/pytorch_imple/blob/main/Education/Openai_api/open_ai_12_%EC%9E%90%EB%8F%99_%EC%9E%90%EB%A7%89_%EC%83%9D%EC%84%B1_%EC%84%9C%EB%B9%84%EC%8A%A4.ipynb)**               | Whisper API를 활용하여 자동으로 자막으로 생성하는 서비스입니다.            |
| **[Whisper API example](https://github.com/PARKYUNSU/pytorch_imple/blob/main/Education/Openai_api/open_ai_13_Whisper_API_example.ipynb)**              | Whisper API를 활용하여 음성을 텍스트로 변환하는 기본 예제입니다.                |
